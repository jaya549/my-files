...
<div class="container-fluid">
	<a href="/questions/${ccode}"
		class="btn btn-primary btn-sm float-right m-2">All Questions</a>
	<h4 class="p-2 border-bottom border-success">Add Question for
		course ${c.description} (${ccode })</h4>
	<div class="row">
		<div class="col-sm-10 mx-auto">
			<form method="post" action="/savequestion">
				<div class="row">
					<div class="col-sm-4">
						<div class="form-group">
							<label>Course Code</label> <input type="text"
								class="form-control form-control-sm" name="ccode" readonly value="${ccode }">
						</div>
					</div>
					<div class="col-sm-4">
						<div class="form-group">
							<label>Question Id</label> <input type="text" readonly
								class="form-control form-control-sm" value="${qid }" name="qid">
						</div>
					</div>
					<div class="col-sm-12">
						<div class="form-group">
					...
					<div class="col-sm-4">
						<div class="form-group">
							<label>Choice 1</label> <input type="text" class="form-control form-control-sm"
								name="ch1">
						</div>
					</div>
					<div class="col-sm-4">
